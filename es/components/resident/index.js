...
import { getResidentManagerLeftTree, getResidentManagerList } from '../../apis';
...
export default function Resident(props) {
  var visible = props.visible,
    ...
    _props$customsQueryIn = props.customsQueryInfo,
    customsQueryInfo = _props$customsQueryIn === void 0 ? {} : _props$customsQueryIn;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              res1 = _context.sent;
              data1 = ((_res1$data = res1.data) === null || _res1$data === void 0 ? void 0 : _res1$data.response) || []; //获取业户---只需要上级是房屋才请求
              if (!(sourceTableType == 'house')) {
                _context.next = 20;
                break;
              }
              //获取房屋
              queryInfo = _objectSpread({
                sourceTableId: parentId,
                sourceTableType: sourceTableType,
                type: residentType
              }, customsQueryInfo);
              _context.next = 14;
              return getResidentManagerList(queryInfo);
            case 14:
              res2 = _context.sent;
              ...
              data2.forEach(function (item) {
                ...
                //赋值头像字段
                item.avatar = item.avatar || item.photo || '';
              });
          ...
          switch (_context2.prev = _context2.next) {
            ...
            case 13:
              ...
              queryInfo = _objectSpread({
                ...
                sourceTableType: item.sourceTableType
              }, customsQueryInfo);
              _context2.next = 16;
              return getResidentManagerList(queryInfo);
            case 16:
              ...
              data.forEach(function (itemSmall) {
                ...
                //赋值头像字段
                itemSmall.avatar = itemSmall.avatar || itemSmall.photo || '';
                // 如果是多选就根据上级选中
                if (!radio) {
          ...
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              for (index = 0; index < listInfo[level].length; index++) {
                ...
                //     }
                //   } else {
                //     let res = await getResidentManagerList({ organizationId: item.id });
  ...
  //   try {
  //     setIsLoading(true);
  //     let res: any = await getResidentManagerLeftTree({ parentId: '0' });
  //     setListInfo({
  //       1: res.data?.response || [],
  //     });
  //     setIsLoading(false);
  ...
  useEffect(function () {
    ...
    if (info && Object.prototype.toString.call(info) === '[object Object]' && Object.keys(info).length > 0) {
      ...
      //初始化
      // getRootDepartment();//没有初始化的了，必须要有上级数据
    }
  }, [info]);
  var identityText = function identityText(item) {
    switch (item.type) {
      case 'family':
        return '家属';
      case 'proprietor':
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Popup, {
  ...
  }, title || '选择住户'), /*#__PURE__*/React.createElement("div", {
    ...
    }, !radio || item.isEmployee ? /*#__PURE__*/React.createElement("div", {
      className: styles.left,
      onClick: function onClick() {
        selectInfo(item);
      }
    ...
    }, item.isEmployee ? /*#__PURE__*/React.createElement("div", {
      className: styles.icon
    }, /*#__PURE__*/React.createElement("img", {
      className: styles.avatar,
      src: item.avatar || require('../../assets/images/profile-default.png'),
      alt: ""
    })) : null, item.isEmployee ? /*#__PURE__*/React.createElement("div", {
      className: styles.residentInfo
    }, /*#__PURE__*/React.createElement("div", {
      className: styles.name
    }, item.name || ''), /*#__PURE__*/React.createElement("div", {
      className: styles.type
    }, identityText(item))) : /*#__PURE__*/React.createElement("div", {
      className: styles.name
    ...
    type: 6,
    queryInfo: _objectSpread({
      sourceTableId: info === null || info === void 0 ? void 0 : info.id,
      sourceTableType: info === null || info === void 0 ? void 0 : info.sourceTableType
    }, customsQueryInfo),
